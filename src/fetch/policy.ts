 ...
 *
 * @module @agents-web-search/core/fetch/policy
 */
 ...
 * bounded length. Returns the parsed `URL`. Throws {@link CoreError} otherwise.
 ...
 * none is declared. Throws {@link CoreError} `WEB_UNSUPPORTED_CONTENT_TYPE` when
